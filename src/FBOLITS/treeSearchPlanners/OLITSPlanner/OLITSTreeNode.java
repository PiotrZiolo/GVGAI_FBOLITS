...
public class OLITSTreeNode extends TreeNode
{
	...
	public OLITSTreeNode(int numOfActions)
	{
		this.parent = null;
		this.totalValue = 0.0;
		this.numVisits = 0;
		this.depth = 0;
		this.children = new OLITSTreeNode[numOfActions];
	...
	public OLITSTreeNode(OLITSTreeNode parent, int numOfActions, int actionLeadingToThisNode)
	{
		this.parent = parent;
		this.totalValue = 0.0;
		this.numVisits = 0;
	...
	public OLITSTreeNode(OLITSTreeNode parent, int numOfActions, int depth, int actionIndex, double tabooBias) {
        this.parent = parent;
        this.children = new OLITSTreeNode[numOfActions];
        this.stateObsNearPOI = false;
		this.path = null;
	...
	public OLITSTreeNode(int numOfActions, PointOfInterest poi)
	{
		this.parent = null;
		this.totalValue = 0.0;
		this.numVisits = 0;
    ...
    public void refreshTree(int depth) 
    {
        ...
        for (OLITSTreeNode child : (OLITSTreeNode[])this.children) {
            if (!(child == null)) {
